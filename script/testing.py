...
data_dir = '../dataset/CK+'
img_size = 75  # assuming the model was trained on 48x48 images
...
model_name = '100_inceptionv3_masked'
model_path = f'../training/{model_name}/{model_name}.h5'
...
plt.savefig(f'testing/{model_name}.png')
plt.close()
