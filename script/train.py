...
train_set = train_datagen.flow_from_directory('/Users/vincentiusverel/Vincent/TugasAkhir/TA_EmotionDetection/dataset/augmented/train',
                                                    target_size = (48, 48),
                                                    batch_size = 32,
                                                    class_mode = 'binary',
                                                    shuffle = False,
...
test_set = test_datagen.flow_from_directory('/Users/vincentiusverel/Vincent/TugasAkhir/TA_EmotionDetection/dataset/fer2013plus/test',
                                                    target_size = (48, 48),
                                                    batch_size = 32,
                                                    class_mode = 'binary',
                                                    shuffle = False,
...
val_predict = np.argmax(basemodel.predict(test_set), axis=-1)  # Get last epoch predictions
